...
function ChatParamsWrapper({ children }: { children: (masterId: string) => React.ReactNode }) {
...
function ChatContent({ masterId }: { masterId: string }) {
      ...
      const initialChats: Record<string, Message[]> = {
        '1': [
          ...
          },
          {
            ...
            sender: 'master',
            timestamp: new Date(Date.now() - 82800000), // 23 часа назад
            read: true
          },
          {
            id: '3',
            ...
            sender: 'user',
            timestamp: new Date(Date.now() - 79200000), // 22 часа назад
            read: true
          },
          {
            id: '4',
            ...
            sender: 'master',
            timestamp: new Date(Date.now() - 75600000), // 21 час назад
            read: true
          }
        ],
        '2': [
...
export default function ChatPage() {
  return (
    <Suspense fallback={<ChatLoading />}>
      <ChatParamsWrapper>
        {(masterId) => <ChatContent masterId={masterId} />}
      </ChatParamsWrapper>
    </Suspense>
  );
} 