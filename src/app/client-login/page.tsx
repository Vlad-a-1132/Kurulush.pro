...
export default function ClientLogin() {
  ...
  return (
    <>
      <Head>
        <title>Вход для клиентов | ПрофиСервис</title>
      </Head>
      
      <div className="max-w-md mx-auto my-16 px-4">
        <h1 className="text-3xl font-bold text-center mb-4 text-gray-900">Вход для клиентов</h1>
        <p className="text-center text-gray-700 mb-8">
          Войдите, чтобы получить доступ к поиску специалистов и управлению заказами
        </p>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-700">
              ...
              <Link href="/client-registration" className="text-blue-600 hover:underline font-medium">
                Зарегистрироваться
              </Link>
            </p>
          </div>
