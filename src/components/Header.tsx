    ...
    <header className="bg-white shadow-md">
      <div className="container mx-auto px-4 py-3 md:py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center mr-4">
              <div className="relative w-8 h-8 md:w-10 md:h-10 mr-2">
                <div className="absolute inset-0 bg-blue-600 rounded-md flex items-center justify-center text-white font-bold text-base md:text-xl">
                  ПС
                </div>
              </div>
              <span className="text-lg md:text-xl font-bold text-blue-700 hidden sm:inline">ПрофиСервис</span>
            </Link>
          ...
          {/* Mobile menu button */}
          <button
            className="sm:hidden p-2 rounded-md text-gray-700 hover:text-blue-600"
          ...
          <div className="hidden sm:flex items-center space-x-4">
            {isLoggedIn && user ? (
              ...
              <>
                <Link href="/specialist-login" className="px-4 py-2 border border-blue-600 text-blue-600 rounded-md hover:bg-blue-50 transition text-sm">
                  Вход для специалистов
                </Link>
                <Link href="/client-login" className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition text-sm">
                  Вход для клиентов
                </Link>
              </>
            )}
